...
import com.chanlin.jetsencloud.BuildConfig;

import java.io.File;
import java.util.Locale;

/**
 * Created by ChanLin on 2018/6/27.
 * jetsen
 * TODO:
 */
public class OpenFileUtil {
    ...
    private static OpenFileUtil openFileUtil;
    public static OpenFileUtil getInstance(Context context){
        if (openFileUtil == null){
            openFileUtil = new OpenFileUtil();
        }
        mContext = context;
        return openFileUtil;
    }
    public void openFile(String filePath){
        Intent it = getFileIntent(filePath);
